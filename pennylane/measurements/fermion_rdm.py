...
from .measurements import FermionRDM, StateMeasurement
...
class FermionRdmMP(StateMeasurement):
    ...
    def process_state(self, state: Sequence[complex], restricted = True):
        return qml.math.fermion_rdm(
            state,
            restricted
        )
